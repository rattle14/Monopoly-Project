...
public enum ePiece { car, thimble, tophat, boot, wheelbarrow, dog, cat, battleship, terminator }
public enum ePlayerType { none, human, AI}
    public enum eDifficulty { intern, manager, CEO }
public enum eTypeSpot {doNothing, property, commChest, chance, tax, railroad, utitily, goToJail }
    public enum ePos { go, mediterranean, commChest1, baltic, incomeTax, readingRR, oriental, chance1, vermont, connecticut, justVisiting, stCharles, electricCompany, states, virginia, pennRR, stJames, commChest2, tennessee, newYork, freeParking, kentucky, chance2, indiana, illinois, boRR, atlantic, ventnor, waterWorks, marvinGardens, goToJail, pacific, northCarolina, commChest3, pennsylvania, shortLineRR, chance3, parkPlace, luxuryTax, boardwalk, terminator };
